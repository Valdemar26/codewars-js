 ...
 * Return true if it is, false if it is not (note that any non-integers,
 * including non-number types, are not triangle numbers).
 *
 * You are encouraged to develop an effective algorithm:
 * test cases include really big numbers.
 *
 * Assumptions:
