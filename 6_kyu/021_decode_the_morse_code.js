 ...
 *
 * The Morse code encodes every character as a sequence
 * of "dots" and "dashes". For example, the letter A is coded as ·−,
 ...
 *
 * The Morse code table is preloaded for you as a dictionary, feel free
 * to use it. In CoffeeScript, C++, JavaScript, PHP, Python, Ruby and TypeScript,
 * the table can be accessed like this: MORSE_CODE['.--'],
