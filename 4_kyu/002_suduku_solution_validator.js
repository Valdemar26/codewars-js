/**
 * 002_sudoku_solution_validator.js
 * https://www.codewars.com/kata/simple-maths-test/train/javascript
 *
 */
 ...
 *
 * Write a function validSolution that accepts a 2D array representing
 * a Sudoku board, and returns true if it is a valid solution, or false otherwise.
 * The cells of the sudoku board may also contain 0's, which will represent
 * empty cells. Boards containing one or more zeroes are considered
  ...
  board.forEach(function(row, i) {
    ...
    row.forEach(function(num, j) {
      ...
      if(i % 3 === 0 && j % 3 === 0) {
        ...
        for(var l = 0; l < 3; l++) {
          for(var m = 0; m < 3; m++) {
            subgrid[subgridIndex][l * 3 + m] = board[i + 1][j + m];
          }
        }
      }
    });
