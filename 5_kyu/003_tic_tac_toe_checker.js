 ...
 * the board's current state is solved, wouldn't we?
 ...
 *
 * You may assume that the board passed in is valid in the context of
 ...
 function isSolved(board) {
   ...
   for(var i = 0; i < board.length; i++) {
     for(var j = 0; j < i; j++) {
       if(board[i][j] === 0) {
         return -1;
       } else if() { // 'X' won pattern
         return 1;
       } else if () { // 'O' won pattern
         return 2;
       } else { // draw pattern
         return 0;
       }
